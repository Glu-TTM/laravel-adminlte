...
Please Access the Original https://github.com/jeroennoten/Laravel-AdminLTE, i just adapted to fill my needs,,,


# Easy AdminLTE integration with Laravel 5

[![Latest Version on Packagist](https://img.shields.io/packagist/v/GluTtm/Laravel-AdminLTE.svg?style=flat-square)](https://packagist.org/packages/GluTtm/Laravel-AdminLTE)
[![Build Status](https://travis-ci.org/GluTtm/Laravel-AdminLTE.svg?branch=master)](https://travis-ci.org/GluTtm/Laravel-AdminLTE)
[![Quality Score](https://img.shields.io/scrutinizer/g/GluTtm/Laravel-AdminLTE.svg?style=flat-square)](https://scrutinizer-ci.com/g/GluTtm/Laravel-AdminLTE)
[![StyleCI](https://styleci.io/repos/38200433/shield?branch=master)](https://styleci.io/repos/38200433)
[![Total Downloads](https://img.shields.io/packagist/dt/GluTtm/Laravel-AdminLTE.svg?style=flat-square)](https://packagist.org/packages/GluTtm/Laravel-AdminLTE)
...
You can report issues and ask questions in the [issues section](https://github.com/GluTtm/Laravel-AdminLTE/issues). Please start your issue with `ISSUE: ` and your question with `QUESTION: `
